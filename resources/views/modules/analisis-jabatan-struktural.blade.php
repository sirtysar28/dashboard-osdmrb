...
@section('page_subtitle', 'Pemetaan formasi & pemangku jabatan struktural (JPT dan pejabat administratif)')
    ...
    <div class="col-lg-12">
        <div class="chart-card">
            ...
            <ul class="small text-muted mb-0 ps-3">
                ...
                <li>Data pejabat diambil dari kolom eselon pegawai aktif dan riwayat jabatan aktif (JPT Pratama, Administrator, Pengawas).</li>
            </ul>
        </div>
    </div>
</div>
