...
Route::middleware('guest')->group(function () {
    ...
    // ---- Layer 2: verifikasi kode OTP email ----
    Route::get('login/otp', [OtpController::class, 'show'])->name('login.otp');
    Route::post('login/otp', [OtpController::class, 'verify'])->name('login.otp.verify');
    Route::post('login/otp/resend', [OtpController::class, 'resend'])->name('login.otp.resend');
    Route::post('login/otp/cancel', [OtpController::class, 'cancel'])->name('login.otp.cancel');
